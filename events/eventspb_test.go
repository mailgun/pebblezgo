...
func TestEventPrimeProto(t *testing.T) {
	popr := math_rand.New(math_rand.NewSource(time.Now().UnixNano()))
	p := NewPopulatedEventPrime(popr, false)
...
func BenchmarkEventPrimeProtoMarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	pops := make([]*EventPrime, 10000)
	for i := 0; i < 10000; i++ {
		pops[i] = NewPopulatedEventPrime(popr, false)
	}
	b.ResetTimer()
	for i := 0; i < b.N; i++ {
...
func BenchmarkEventPrimeProtoUnmarshal(b *testing.B) {
	popr := math_rand.New(math_rand.NewSource(616))
	total := 0
	datas := make([][]byte, 10000)
	for i := 0; i < 10000; i++ {
		data, err := code_google_com_p_gogoprotobuf_proto.Marshal(NewPopulatedEventPrime(popr, false))
		if err != nil {
			panic(err)
		}
		datas[i] = data
...
func TestEventPrimeJSON(t *testing1.T) {
	popr := math_rand1.New(math_rand1.NewSource(time1.Now().UnixNano()))
	p := NewPopulatedEventPrime(popr, true)
...
func TestEventPrimeProtoText(t *testing2.T) {
...
func TestEventPrimeProtoCompactText(t *testing2.T) {
	popr := math_rand2.New(math_rand2.NewSource(time2.Now().UnixNano()))
	p := NewPopulatedEventPrime(popr, true)
...
func TestEventPrimeStringer(t *testing3.T) {
...
func TestEventPrimeSize(t *testing4.T) {
...
func BenchmarkEventPrimeSize(b *testing4.B) {
	popr := math_rand4.New(math_rand4.NewSource(616))
	total := 0
	pops := make([]*EventPrime, 1000)
	for i := 0; i < 1000; i++ {
		pops[i] = NewPopulatedEventPrime(popr, false)
	}
	b.ResetTimer()
...
func TestEventPrimeGoString(t *testing5.T) {
...
func TestEventPrimeFace(t *testing6.T) {
...
func TestEventPrimeVerboseEqual(t *testing7.T) {
...
func TestEventsDescription(t *testing8.T) {
	EventsDescription()
}
